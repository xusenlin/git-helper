...
export function AddBranch(arg1:string):Promise<void>;
...
export function OpenFileManage():Promise<void>;
...
export function ShowWorkTreeFile(arg1:string,arg2:number):Promise<Array<repository.DiffContent>>;
